...
wb=openpyxl.load_workbook(r"C:\Users\vkamb\Desktop\Data Mining Lab/Exp10.xlsx") 
sheet = wb.active
row = sheet.max_row
...
while row>2:
  ...
  wb.save(r"C:\Users\vkamb\Desktop\Data Mining Lab/Exp10.xlsx")
  row = sheet.max_row
  print(row)
  ...
  wb.save(r"C:\Users\vkamb\Desktop\Data Mining Lab/Exp10.xlsx")
  wb.save(r"C:\Users\vkamb\Desktop\Data Mining Lab/Exp10.xslx"+str(cnt)+".xlsx")
  cnt=cnt+1
  row = sheet.max_row
  print(row)